...
def get_model_5(opt, name='Model'):
    model = eval(name)(opt)
    model.to("cuda")
...
class Model(nn.Module):
    def __init__(self, opt):
        ...
        self.fusion_local_global = nn.ModuleList([
    ...
    def visual_local_global(self, local_img, global_img, bbox, text_feat=None, kum_mode=None):
        ...
        local_feat = self.feature_extractor(local_img)  # [bt,c,7,7]
        ...
        global_feat = self.feature_extractor(global_img)  # [bt,c,7,7]
        # rearrange
        ...
        if kum_mode == 'text-first modulation':
            ...
            for layer in self.fusion_local_global:
                ...
                # exp 13 fusion_feat = fusion_feat + local_feat
            # exp 17 + 19 
            fusion_feat = fusion_feat + local_feat
        # text-guided
