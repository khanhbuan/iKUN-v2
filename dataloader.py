    ...
    def _parse_data(self):
        ...
        for video in VIDEOS[self.mode]:
            ...
            for obj_id in ids:
                ...
                # Identify the track breakpoints to facilitate individual processing of each sub-tracklet
                ...
                # Divide tracklets into segments by sample_stride
                total_length = 0
